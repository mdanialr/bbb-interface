...
type fakeConfError struct{}

func (f *fakeConfError) ReloadConfig(_ io.Reader) error { return fmt.Errorf("error") }

func (f *fakeConfError) SanitizationLog() {}

func (f *fakeConfError) Sanitization() error { return nil }
...
func TestReloadConfig(t *testing.T) {
	...
	t.Run("2# should log error but keep continue to next handler", func(t *testing.T) {
		var fConf fakeConfError
		configFilePath = "/tmp/no_exist.yml"
